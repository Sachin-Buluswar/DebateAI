...
const cardVariants = cva('rounded-xl transition-all duration-300', {
  variants: {
    variant: {
      ...
      glass:
        'bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-white/20 dark:border-gray-700/50 shadow-glass',
      gradient:
...
const cardHeaderVariants = cva('font-semibold tracking-tight', {
  variants: {
    size: {
      sm: 'text-lg',
      md: 'text-xl',
