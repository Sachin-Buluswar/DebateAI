...
const features = [
  {
    ...
    description:
      'practice against intelligent ai opponents. get real-time feedback. improve your skills through structured formats.',
    href: '/debate',
  },
  {
    name: 'speech feedback',
    description:
      'upload or record your speeches. receive detailed analysis on delivery, pacing, and clarity. refine your technique.',
    href: '/speech-feedback',
  },
  {
    name: 'evidence search',
    description:
      'find relevant debate evidence using our vector-based search. access comprehensive wiki articles instantly.',
    href: '/search',
  },
  {
    name: 'secure platform',
    description:
      'your data is protected with row-level security. authenticated access. private practice environment.',
    href: '/auth',
  },
];
        ...
        <section className="breathing-room max-w-6xl mx-auto">
          <div className="space-y-8">
            <h1 className="animate-fade-in">
              <span className="block text-gray-900 dark:text-gray-100">master the art</span>
              <span className="block text-primary-500 mt-2">of debate</span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl animate-fade-in stagger-1">
              a distraction-free platform for developing your debate skills through ai-powered
        ...
        <section className="breathing-room max-w-6xl mx-auto">
          <div className="space-y-section">
            <div className="space-y-4">
              <h2 className="text-gray-900 dark:text-gray-100">everything you need</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              {features.map((feature, index) => (
                ...
                >
                  <h3 className="text-primary-500">{feature.name}</h3>
        ...
        <section className="breathing-room max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              created by nationally-ranked high school debaters who believe great debate education
              shouldn't require expensive coaches
            </p>
            <Link
              href="/about"
          ...
          <div className="max-w-6xl mx-auto px-8 py-12">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <nav className="flex space-x-8">
                ...
                <Link
                  href="/about"
                  className="text-sm text-gray-500 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-100"
                >
                  about
                </Link>
                <Link
