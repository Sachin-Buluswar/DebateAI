...
export async function GET(request: NextRequest) {
  ...
  if (error) {
    ...
    return NextResponse.redirect(`${requestUrl.origin}/auth?error=${errorMessage}&code=${errorCode}`)
  }
  ...
  if (code) {
    ...
    try {
      ...
      return NextResponse.redirect(`${requestUrl.origin}/auth?error=session_failed&code=no_session`)
