...
function ResourceCard({ resource }: { resource: Resource }) {
  ...
  return (
    <Link href={`/learn/${resource.category}/${resource.slug}`} className="block group">
  ...
  return (
    <div className="breathing-room max-w-6xl mx-auto">
      ...
      <div className="space-y-6 mb-12 animate-fade-in">
        <h1 className="text-gray-900 dark:text-gray-100">learn debate fundamentals</h1>
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl">
          free resources created by nationally-ranked debaters to help you master public forum
          debate
        </p>
      </div>
      ...
      {!loading && !error && !message && featuredResources.length > 0 && (
        <section className="mb-12 animate-fade-in stagger-2">
          <h2 className="text-2xl text-gray-900 dark:text-gray-100 mb-6">featured resources</h2>
