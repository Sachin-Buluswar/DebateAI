...
export default function ResourceViewerPage() {
  ...
  const trackEvent = useCallback(
    async (eventType: 'view' | 'download' | 'share') => {
      if (!resource) return;
      ...
      <div className="space-y-6 mb-8 animate-fade-in">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h1 className="text-gray-900 dark:text-gray-100 mb-2">{resource.title}</h1>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">{resource.description}</p>
          </div>
        </div>
        ...
        >
          <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m9.032 4.026a3 3 0 10-5.432 2.684m5.432-2.684l-5.432 2.684m0-14.368a3 3 0 105.432-2.684m-5.432 2.684l5.432-2.684"
            />
          </svg>
          Share
        </button>
