          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Your feedback is valuable and helps us make Eris Debate better for everyone. Whether
                you&apos;ve found a bug, have a feature suggestion, or just want to share your
