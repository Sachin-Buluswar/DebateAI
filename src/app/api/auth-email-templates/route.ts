...
<p>If you didn't register for DebateAI, you can safely ignore this email.</p>
<p>Happy debating!<br>The DebateAI Team</p>
`;

  const inviteUserTemplate = `
<h2>You've been invited to join DebateAI</h2>
<p>You've been invited to create a user on DebateAI, the AI-powered platform for debate training.</p>
<p>Click the link below to accept the invite:</p>
<p><a href="{{ .ConfirmationURL }}">Accept Invitation</a></p>
<p>The link will expire in 24 hours.</p>
<p>If you have any questions, feel free to reach out to our support team.</p>
<p>Best regards,<br>The DebateAI Team</p>
`;

  const magicLinkTemplate = `
<h2>Magic Link for DebateAI</h2>
<p>Click the link below to sign in to your DebateAI account:</p>
...
<h2>Reset Your DebateAI Password</h2>
<p>You have requested to reset your password on DebateAI.</p>
...
<h2>Confirm Email Change for DebateAI</h2>
<p>You have requested to update your email address on DebateAI.</p>
