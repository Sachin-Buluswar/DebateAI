...
const PreferencesProvider = dynamic(
  () =>
    import('@/components/providers/PreferencesProvider').then((mod) => ({
      default: mod.PreferencesProvider,
    })),
  {
    ssr: true,
  }
...
export const metadata: Metadata = {
  ...
  description:
    'Master debate skills with AI-powered practice sessions, real-time speech feedback, and comprehensive argument analysis',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full">
      <body
        className={`${inter.variable} font-sans antialiased h-full w-full transition-colors duration-300`}
      >
                  ...
                  fallback={
                    <div className="flex min-h-screen items-center justify-center flex-col p-4">
                      <div className="bg-red-100 text-red-600 p-6 rounded-lg shadow-md max-w-lg">
                        ...
                        <Link
                          href="/"
                          className="inline-block bg-primary-500 text-white px-4 py-2 rounded font-medium hover:bg-primary-600 transition-colors"
                        >
                          Return Home
                        </Link>
                      </div>
