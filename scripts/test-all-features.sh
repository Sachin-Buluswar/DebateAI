...
test_endpoint "GET" "/api/auth/callback" "" "400" "Auth callback (expect 400 without params)"
...
test_endpoint "POST" "/api/wiki-rag-search" '{"query":"test"}' "503" "RAG search (expect 503 without vector store)"
